...
Cria-se uma lógica simples que decide: Se todos os valores estão dentro da faixa segura → PRONTO PARA DECOLAR; Se algum valor está fora → DECOLAGEM ABORTADA
...
Dentro do Python ele pode gerar:
